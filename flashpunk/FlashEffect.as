package rahil.flashpunk
{
	...
	public class FlashEffect
	{
		 ...
		 * @param the area of effect, by default it flashes the entire screen
		 * 
		 */		
		public function start(colour:uint = 0xFFFFFF, duration:Number = 0.5, rectangle:Rectangle = null):void
		{
			stop();
			this.colour = colour;
			...
			if (!rectangle)
				this.rectangle = new Rectangle(0, 0, buffer.width, buffer.height);
		}
		...
		public function render():void
		{
			if(alpha > 0) 
			{
				buffer.fill(rectangle, colour, alpha);
